...
from .data_source import jiangan_food, wangjiang_food,  _font_path, _font_path_xingkai, _font_path_hupo
...
def reward_display(cubeevent, username1, username2, username3):
    ...
    background = Image.open('background.png').resize(img_size)
    ...
    img1 = MessageSegment.image('file:///' + os.path.abspath('reward1.png'))
    ...
    img2 = MessageSegment.image('file:///' + os.path.abspath('reward2.png'))
    ...
    img3 = MessageSegment.image('file:///' + os.path.abspath('reward3.png'))
